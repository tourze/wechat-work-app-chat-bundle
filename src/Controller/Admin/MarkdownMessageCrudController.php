 ...
 */
#[AdminCrud(routePath: '/wechat-work-app-chat/markdown-messages', routeName: 'wechat_work_app_chat_markdown_messages')]
final class MarkdownMessageCrudController extends AbstractCrudController
{
    ...
    public function configureCrud(Crud $crud): Crud
    {
        return $crud
            ...
            ->setPageTitle('index', '企业微信群聊Markdown消息管理')
            ->setPageTitle('new', '新建Markdown消息')
            ->setPageTitle('edit', '编辑Markdown消息')
            ->setPageTitle('detail', 'Markdown消息详情')
    ...
    public function configureFields(string $pageName): iterable
    {
        ...
        yield TextareaField::new('content', '消息内容')
            ->setRequired(true)
            ->setMaxLength(4096)
            ->setHelp('Markdown格式的消息内容，最多4096个字符')
            ->setNumOfRows(8)
        ;
