...
use WechatWorkAppChatBundle\Controller\Admin\FileMessageCrudController;
...
{
    protected function getControllerService(): FileMessageCrudController
    {
        /** @var FileMessageCrudController */
        return self::getContainer()->get(FileMessageCrudController::class);
    }
    ...
    {
        $controller = new FileMessageCrudController();
        $fields = iterator_to_array($controller->configureFields('new'));
        $this->assertNotEmpty($fields);
    ...
    {
        $controller = new FileMessageCrudController();
        $this->assertEquals(FileMessage::class, $controller::getEntityFqcn());
    }

    private function validatePhpStanRequirements(): void
    {
        $controller = new FileMessageCrudController();
        $this->assertInstanceOf(FileMessageCrudController::class, $controller);

        // FileMessage requires parameters, so just test class reflection
        $reflection = new \ReflectionClass(FileMessage::class);
