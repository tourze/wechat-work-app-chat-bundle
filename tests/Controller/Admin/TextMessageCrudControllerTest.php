...
use WechatWorkAppChatBundle\Controller\Admin\TextMessageCrudController;
...
final class TextMessageCrudControllerTest extends AbstractEasyAdminControllerTestCase
{
    ...
    {
        /** @var TextMessageCrudController */
        return self::getContainer()->get(TextMessageCrudController::class);
    }
    ...
    public function testGetEntityFqcn(): void
    {
        ...
        $this->assertSame(TextMessage::class, $controller::getEntityFqcn());
    }
    ...
    {
        $controller = new TextMessageCrudController();
        $this->assertEquals(TextMessage::class, $controller::getEntityFqcn());
    }

    private function validatePhpStanRequirements(): void
    {
        $controller = new TextMessageCrudController();
        $this->assertInstanceOf(TextMessageCrudController::class, $controller);

        // TextMessage requires parameters, so just test class reflection
        $reflection = new \ReflectionClass(TextMessage::class);
